...
image::quickstart-java27-cb65/intellij-create-new-project-1.png[New Project dialog in IntelliJ, 480,align=left]

Select the Maven template in the next dialog:

image::quickstart-java27-cb65/intellij-create-new-project-2.png[Template select in IntelliJ, 480,align=left]

Inform a name for your project and click on *Finish*:

image::quickstart-java27-cb65/intellij-create-new-project-3.png[Project name in IntelliJ, 480,align=left]

In the end, your project should look similar to the following:

image::quickstart-java27-cb65/intellij-create-new-project-4.png[Project name in IntelliJ, 720,align=left]


Now, right-click on the *java* folder of your project and select *new -> package* and choose a name for your new package:

image::quickstart-java27-cb65/intellij-create-package.png[Create Package, 360,align=left]
