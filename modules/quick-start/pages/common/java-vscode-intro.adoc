...
image::quickstart-java27-cb65/vscode-start-new-project.png[New Project dialog in IntelliJ, 720,align=left]

Select the *maven-archetype-quickstart* in the dialog that opens:

image::quickstart-java27-cb65/vscode-maven-1.png[Template select in IntelliJ, 480,align=left]

Then pick the option *1.4* in the next dialog:

image::quickstart-java27-cb65/vscode-maven-2.png[MVN Version, 480,align=left]
...
image::quickstart-java27-cb65/vscode-maven-3.png[Maven Questions, 720,align=left]
...
image::quickstart-java27-cb65/vscode-final-project.png[New Project, 720,align=left]
...
image::quickstart-java27-cb65/vscode-new-class.png[New Class, 480,align=left]
