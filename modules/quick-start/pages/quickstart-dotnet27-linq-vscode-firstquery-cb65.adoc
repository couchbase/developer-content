...
Be sure to check out the other quick start exercises. link:https://github.com/couchbase/developer-content/tree/master/modules/quick-start/examples/quickstart-netcore31-cb65/FirstQuery[The complete source code is available on GitHub].
